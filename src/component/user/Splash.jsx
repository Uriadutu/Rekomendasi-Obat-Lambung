    ...
    <div className="flex bg-gradient-to-b from-[#0c8e20] to-[#027514] sm:bg-gradient-to-bl sm:from-[#0c8e20] sm:to-[#027514] min-h-screen w-full px-6 md:px-16 lg:px-32 xl:px-52 items-center justify-center">
      <div className="flex flex-col md:grid md:grid-cols-3 gap-10 items-center text-center md:text-left">
        ...
        <div className="order-3 md:col-span-3 flex justify-start">
          <Link
            to={"/beranda"}
            className="mt-10 mb-10 bg-[#5D5D5D] bg-opacity-30 text-white py-2 px-10 md:px-20 border border-white rounded-[2px] hover:bg-gray-100 hover:text-gray-700 transition duration-300 inline-block"
          >
            Mulai
          </Link>
        </div>
